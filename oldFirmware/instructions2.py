...
while odrive0.axis0.motor.current_control.Iq_setpoint and odrive0.axis1.motor.current_control.Iq_setpoint and odrive1.axis0.motor.current_control.Iq_setpoint:
    print("Moving1...")
